...
(331,	'document',	'text/html',	'Главная демо-сайта', 'Главная демо-сайта', '', 'index', '', 1, 0, 0, 0, 0, '', '<h1>Вывод товаров с помощью DocLister</h1><div class="cataloglist">[[DocLister? &tpl=`DLproduct` &parents=`338` &prepare=`TSVshopPrepare` &tvList=`cart_icon,price,typeitem,tsvshop_param`]]</div>\r\n<h1>Вывод товаров с помощью Ditto</h1><div class="cataloglist">[[Ditto? &tpl=`product` &parents=`338` &extenders=`shop`]]</div>\r\n',
...
(141, 'text', 'price', 'Цена товара', 'Параметр <b>обязателен</b>', 0, 38, 0, '', 0, '', '', ''),
