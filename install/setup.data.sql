...
(341,	'document',	'text/html',	'Микроволновка (демо-сайт)', 'Микроволновка', 'Микроволновка', '', '', 1, 0, 0, 338, 0, 'Микроволновка', '', 1, 31, 1, 1, 1, 1, 1326978714, 1, 1326978714, 0, 0, 0, 1326978714, 1, 'Микроволновка', 0, 0, 0, 0, 0, 0, 0),
(343,'document','text/html','Мои заказы (демо-сайт)','Мои заказы (демо-сайт)','Мои заказы (демо-сайт)','','','1','0','0','336','0','Мои заказы (демо-сайт)','[!TSVoffice? &act=`listorders` &orderpage=`344`!]','1','32','1','1','1','1','1326978714','1','1326978714','0','0','0','1326978714','1','Мои заказы (демо-сайт)','0','0','0','0','0','0','0','1'),
(344,'document','text/html','Просмотр заказа (демо-сайт)','Просмотр заказа (демо-сайт)','Просмотр заказа (демо-сайт)','','','1','0','0','336','0','Просмотр заказа (демо-сайт)','<p><a href=\"[~336~]\">Назад к списку заказов</a></p>[!TSVoffice? &act=`showorder`!]<p><a href=\"[~336~]\">Назад к списку заказов</a></p>','1','32','1','1','1','1','1326978714','1','1326978714','0','0','0','1326978714','1','Просмотр заказа (демо-сайт)','0','0','0','0','0','0','0','1'),
(345,'document','text/html','Редактирование профиля (демо-сайт)','Редактирование профиля (демо-сайт)','Редактирование профиля (демо-сайт)','redaktirovanie-profilya','','1','0','0','336','0','Редактирование профиля (демо-сайт)','[!TSVoffice? &amp;act=`editprofile`!]','1','32','1','1','1','1','1326978714','2','1451913997','0','0','0','0','2','Редактирование профиля (демо-сайт)','0','0','0','0','0','0','0','1');
...
(145, 'image', 'cart_icon', 'Картинка товара', 'Выводится в каталоге, корзине и инфоблоке', 0, 13, 0, '', 0, '', '', ''),
(143, 'textareamini',	'tsvshop_param', 'Параметры товара',	'Дополнительные параметры товара, влияющие на цену', 0, 13, 0, '', 0, '', '', ''),
(144, 'text', 'articul', 'Артикул', 'Артикул товара', 0, 13, 0, '', 0, '', '', ''),
(141, 'number', 'price', 'Цена товара', 'Параметр <b>обязателен</b>', 0, 13, 0, '', 0, '', '', ''),
(146, 'number', 'inventory', 'Кол-во на складе', '', 0, 13, 0, '', 0, '', '', ''),
